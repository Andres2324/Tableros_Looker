...
Para ello es necesario crear una cuenta en Looker Studio con una cuenta de correo en gmail es suficiente.
...
Además de los gráficos, tablas, es posible insertar imagenes, texto, formas entre otros elementos típicos de procesadaores de texto y que pueden utilizarse desde el menú.

![](imagenes/menu texto.png)

Estos son algunos de los elementos típicos de los tableros en Looker Studio que podemos incorporar:
...
-   **Fecha de actualización:** Puede colocarse con un "cuadro de resultados" para automatizar la fecha de actualización considerando el valor máximo de una columna en formato fecha de nuestra base de datos.

-   **Título:** El título puede colocarse de manera intuitiva como si fuera un procesador de texto de Google Docs. Se puede editar su color, fondo, formato, insertar imágenes, entre otros recursos. Mas allá del diseño corresponde en el título poder explicitar desde que institución fue producido
...
La prefiguración del tablero permite identificar el procesamiento de los datos que necesitamos realizar para alcanzar esas visualizaciones.
